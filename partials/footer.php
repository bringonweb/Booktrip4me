<footer class="footer">
  <div class=" footer__container">
    <div class="footer__col">
      ...
      <p>
        Booktrip4me acts solely as an independent intermediary and is not affiliated with any airline or service
        provider. All bookings, changes, and cancellations are subject to respective provider policies. We do not
        guarantee availability, accuracy, or final confirmation.
    ...
    <div class="footer__col">
      ...
      <ul class="footer__links">
        <li class="cc">USA</li>
        <li class="cc">Venezuela</li>
        <li class="cc">Brazil</li>
        <li class="cc">Australia</li>
        <li class="cc">London</li>
      </ul>
    </div>
    <div class="footer__col">
      ...
      <ul class="footer__links">
        ...
        <li>
          <a href="mailto:support@booktrip4me.com">
            <span><i class="ri-mail-fill"></i></span>support@booktrip4me.com
          </a>
      </ul><br>
      <ul class="footer__socials">
        <li>
          <a href="https://www.facebook.com/profile.php?id=61576593982916" rel="noopener" target="_blank"><i
